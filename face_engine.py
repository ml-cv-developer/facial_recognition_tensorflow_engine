...
class FaceEngine:
    ...
    def detect_face(self, image, image_size=160, margin=11):
...
if __name__ == '__main__':
    ...
    img_aligned1, detect_boxes1 = class_face.detect_face(file_images[0])
    img_aligned2, detect_boxes2 = class_face.detect_face(file_images[1])
